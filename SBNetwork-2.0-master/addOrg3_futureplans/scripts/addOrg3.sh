...
export PEER0_ORG3_CA=${PWD}/../crypto-config/peerOrganizations/org3.smartbagng.com/peers/peer0.org3.smartbagng.com/tls/ca.crt
...
setGlobalsForPeer0Org3() {
    ...
    export CORE_PEER_MSPCONFIGPATH=${PWD}/../crypto-config/peerOrganizations/org3.smartbagng.com/users/Admin@org3.smartbagng.com/msp
...
signConfigtxAsPeerOrg() {
    ...
    peer channel update -f org3_update_in_envelope.pb -c ${CHANNEL_NAME} \
        -o localhost:7050 --ordererTLSHostnameOverride orderer.smartbagng.com \
